...
서버 PR #14와 PC 실행기 PR #15는 독립 리뷰·교차 판정·CI를 통과해 머지했다.
마지막 채팅 UI PR과 운영 배포를 진행 중이며, 운영 VM·사용자 채널·설치 앱에는 아직 새 기능을 적용하지 않았다.
...
1. 마지막 채팅 UI PR의 독립 리뷰·교차 판정·CI 후 머지. 서버 #14·실행기 #15는 완료했다.
